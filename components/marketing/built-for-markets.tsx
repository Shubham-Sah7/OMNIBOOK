...
import { Zap, Clock, ShieldCheck, Globe, Activity, Check } from "lucide-react"
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-12">
            ...
            <BentoCard className="p-8 text-left">
              <div className="mb-6 flex items-center justify-between">
                <div className="flex items-center gap-2">
                  <div className="flex h-9 w-9 items-center justify-center rounded-lg border border-white/[0.08] bg-[#0c0c0c] text-white">
                    <Activity className="h-5 w-5 stroke-[1.75]" />
                  </div>
                  <div>
                    <h3 className="text-lg font-bold text-white">Live Order Book Depth</h3>
                    <p className="text-xs text-gray-4">Continuous matching engine with real-time probability curves</p>
                  </div>
                </div>
              ...
              <div className="rounded-xl border border-white/[0.06] bg-[#07080a] p-5">
                <div className="mb-3 flex justify-between font-mono text-xs">
                  <span className="font-bold text-white">YES PROBABILITY: {sliderVal}%</span>
                ...
                <input
                  ...
                  className="h-2 w-full cursor-pointer appearance-none rounded-lg bg-[#1c1c1c] accent-[#00D8F6]"
                />
                <div className="mt-3 flex justify-between font-mono text-[11px] text-gray-4">
          ...
          <div className="md:col-span-4">
            <BentoCard className="flex flex-col justify-between p-8 text-left">
              <div>
                <div className="mb-4 flex h-9 w-9 items-center justify-center rounded-lg border border-white/[0.08] bg-[#0c0c0c] text-white">
                  <Clock className="h-5 w-5 stroke-[1.75]" />
                </div>
                <h3 className="text-lg font-bold text-white">Sub-Second Settlement</h3>
              ...
              <div className="mt-6 flex items-center justify-between rounded-lg border border-white/[0.06] bg-[#07080a] px-3.5 py-2.5 font-mono text-xs">
                <span className="text-gray-4">AVERAGE LATENCY</span>
                <span className="font-bold text-white">42ms</span>
              </div>
            </BentoCard>
          </div>
          ...
          <div className="md:col-span-5">
            <BentoCard className="flex flex-col justify-between p-8 text-left">
              <div>
                ...
                <h3 className="text-lg font-bold text-white">Transparent Oracle Resolution</h3>
                <p className="mt-2 text-xs leading-relaxed text-gray-4">
              ...
              <div className="mt-6 flex items-center gap-2 font-mono text-xs text-gray-4">
          ...
          <div className="md:col-span-7">
            <BentoCard className="p-8 text-left">
              ...
              <h3 className="text-lg font-bold text-white">Global Event Index</h3>
              <p className="mt-2 text-xs leading-relaxed text-gray-4">
              ...
              <div className="mt-6 flex flex-wrap gap-2 font-mono text-xs">
                <span className="rounded border border-white/[0.08] bg-white/[0.03] px-3 py-1 text-white">CRYPTO 60s</span>
                <span className="rounded border border-white/[0.08] bg-white/[0.03] px-3 py-1 text-white">MACROECONOMICS</span>
                <span className="rounded border border-white/[0.08] bg-white/[0.03] px-3 py-1 text-white">POLITICAL ELECTIONS</span>
                <span className="rounded border border-white/[0.08] bg-white/[0.03] px-3 py-1 text-white">AI BENCHMARKS</span>
              </div>
            </BentoCard>
          </div>
        </div>
